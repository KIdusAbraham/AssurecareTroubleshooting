select sqlserver_start_time, physical_memory_kb*1.00/1024/1024 [Memory GB], cpu_count/hyperthread_ratio [Physical CPUs], cpu_count [Cores], virtual_machine_type_desc [VM Type], @@version
...
/*
select 'Blocked Session Details' 'Blocked Session Details'
	, a.spid 'blocked spid'
...
exec dbatools..sp_whoisactive @get_plans = 1, @get_additional_info = 1
